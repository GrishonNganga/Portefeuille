    ...
    return (
        <Link prefetch={false} href={props.card!.url}>
            ...
            >
                ...
                <div
                    className="absolute top-0 w-full h-full flex justify-center z-30 text-[#F9FFF2] font-silk md:text-base lg:text-lg xl:text-xl 2xl:text-3xl py-5 flipCard-front">
